    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div id="info-biaya-gelombang">
                <?php if($pendaftaran && $pendaftaran->harga_gelombang > 0): ?>
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Informasi Pembayaran:</strong>
                        <ul class="mb-0 mt-2">
                            <li><strong>Gelombang:</strong> <span id="info-gelombang"><?php echo e($pendaftaran->gelombang); ?></span></li>
                            <li><strong>Jenis Pembayaran:</strong> <span id="info-jenis-pembayaran"><?php echo e($pendaftaran->jenis_pembayaran ?? 'Uang Pendaftaran'); ?></span></li>
                            <li><strong>Jumlah Pembayaran:</strong> <span class="text-success fw-bold" id="info-harga">Rp <?php echo e(number_format($pendaftaran->harga_gelombang, 0, ',', '.')); ?></span></li>
                            <div id="info-tujuan-rekening-container">
                                <?php if($pendaftaran->tujuan_rekening): ?>
                                    <li><strong>Tujuan Rekening:</strong>
                                        <div id="info-tujuan-rekening" style="margin-top: 8px; padding: 10px; background-color: #e7f3ff; border-left: 3px solid #0ea5e9; border-radius: 4px;">
                                            <?php echo e($pendaftaran->tujuan_rekening); ?>
            ...
            <?php if($pendaftaran): ?>
                <form action="<?php echo e(route('user.pembayaran.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="metode_id" id="metode_id" class="form-select <?php $__errorArgs = ['metode_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $metode; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m->id); ?>" data-kode="<?php echo e($m->kode); ?>" <?php echo e(old('metode_id') == $m->id ? 'selected' : ''); ?>>
                                    <?php if($m->kode === 'transfer_bank'): ?>
                                        <i class="fas fa-university"></i> <?php echo e($m->label); ?>

                                    <?php elseif($m->kode === 'e_wallet'): ?>
                                        <i class="fas fa-mobile-alt"></i> <?php echo e($m->label); ?>
                    ...
                    <div id="transfer_bank_section" style="display: none;" class="mb-4 p-3 border border-info rounded" style="background-color: #f0f7ff;">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="nama_bank" id="nama_bank" class="form-select <?php $__errorArgs = ['nama_bank'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="Bank Mandiri" <?php echo e(old('nama_bank') == 'Bank Mandiri' ? 'selected' : ''); ?>>Bank Mandiri</option>
                                    <option value="Bank BCA" <?php echo e(old('nama_bank') == 'Bank BCA' ? 'selected' : ''); ?>>Bank BCA</option>
                                    <option value="Bank BNI" <?php echo e(old('nama_bank') == 'Bank BNI' ? 'selected' : ''); ?>>Bank BNI</option>
                                    <option value="Bank BTN" <?php echo e(old('nama_bank') == 'Bank BTN' ? 'selected' : ''); ?>>Bank BTN</option>
                                    <option value="Bank CIMB Niaga" <?php echo e(old('nama_bank') == 'Bank CIMB Niaga' ? 'selected' : ''); ?>>Bank CIMB Niaga</option>
                                    <option value="Bank Permata" <?php echo e(old('nama_bank') == 'Bank Permata' ? 'selected' : ''); ?>>Bank Permata</option>
                                    <option value="Bank Danamon" <?php echo e(old('nama_bank') == 'Bank Danamon' ? 'selected' : ''); ?>>Bank Danamon</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="atas_nama_rekening" id="atas_nama_rekening"
                                       class="form-control <?php $__errorArgs = ['atas_nama_rekening'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       placeholder="Nama pemilik rekening" value="<?php echo e(old('atas_nama_rekening')); ?>">
                                <?php $__errorArgs = ['atas_nama_rekening'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div id="ewallet_section" style="display: none;" class="mb-4 p-3 border border-success rounded" style="background-color: #f0fff4;">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="jenis_ewallet" id="jenis_ewallet" class="form-select <?php $__errorArgs = ['jenis_ewallet'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="GoPay" <?php echo e(old('jenis_ewallet') == 'GoPay' ? 'selected' : ''); ?>>GoPay</option>
                                    <option value="OVO" <?php echo e(old('jenis_ewallet') == 'OVO' ? 'selected' : ''); ?>>OVO</option>
                                    <option value="DANA" <?php echo e(old('jenis_ewallet') == 'DANA' ? 'selected' : ''); ?>>DANA</option>
                                    <option value="LinkAja" <?php echo e(old('jenis_ewallet') == 'LinkAja' ? 'selected' : ''); ?>>LinkAja</option>
                                </select>
                                <?php $__errorArgs = ['jenis_ewallet'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nomor_ewallet" id="nomor_ewallet"
                                       class="form-control <?php $__errorArgs = ['nomor_ewallet'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('nomor_ewallet')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="bukti" id="bukti" class="form-control <?php $__errorArgs = ['bukti'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="keterangan" class="form-control" rows="3" 
                                  placeholder="Tambahkan catatan jika diperlukan..."><?php echo e(old('keterangan')); ?></textarea>
                    </div>
            ...
            <?php else: ?>
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <a href="<?php echo e(route('formulir.index')); ?>" class="alert-link">Isi formulir sekarang</a>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <?php endif; ?>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadHargaGelombang() {
        const gelombang = '<?php echo e($pendaftaran->gelombang ?? ""); ?>';
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppdb_denico_09\resources\views/user/pembayaran.blade.php ENDPATH**/ ?>