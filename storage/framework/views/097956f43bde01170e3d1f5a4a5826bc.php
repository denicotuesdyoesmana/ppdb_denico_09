...
<div class="container-fluid px-4">
    ...
    <?php if($formulirBelumDiisi): ?>
        <div class="alert alert-danger alert-dismissible fade show mb-3" role="alert">
            <i class="fas fa-exclamation-triangle me-2"></i>
            <strong>⚠️ Perhatian!</strong><br>
            Anda belum mengisi <strong>Formulir Pendaftaran</strong>. Silakan <a href="<?php echo e(route('formulir.index')); ?>" class="alert-link fw-bold">isi Formulir Pendaftaran terlebih dahulu</a> sebelum melanjutkan ke biodata.
            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        </div>
    <?php endif; ?>
            ...
            <form action="<?php echo e(route('biodata.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" value="<?php echo e(old('nama_lengkap', $biodata->nama_lengkap ?? $siswa->nama_lengkap ?? '')); ?>" placeholder="Masukkan nama lengkap" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" value="<?php echo e(old('tempat_lahir', $biodata->tempat_lahir ?? $siswa->tempat_lahir ?? '')); ?>" placeholder="Contoh: Sidoarjo" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?>>
                        <small class="text-muted">Hanya huruf dan spasi</small>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" class="form-control" name="tanggal_lahir" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?> value="<?php echo e(old('tanggal_lahir', $biodata->tanggal_lahir ?? $siswa->tanggal_lahir ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="jenis_kelamin" <?php echo e($isSubmitted ? 'disabled' : 'required'); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="agama" <?php echo e($isSubmitted ? 'disabled' : 'required'); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea class="form-control" name="alamat" id="alamat" rows="2" placeholder="Tuliskan alamat lengkap sesuai KK" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?>><?php echo e(old('alamat', $biodata->alamat ?? $siswa->alamat ?? '')); ?></textarea>
                ...
                <div class="mb-4">
                    <div class="btn-group w-100" role="group">
                        <input type="radio" class="btn-check" name="jenis_pendamping" id="ortu_option" value="ortu" 
                               <?php echo e(old('jenis_pendamping', ($biodata->nama_ayah ?? null) ? 'ortu' : 'wali') == 'ortu' ? 'checked' : ''); ?>

                               <?php echo e($isSubmitted ? 'disabled' : ''); ?>>
                        ...
                        <input type="radio" class="btn-check" name="jenis_pendamping" id="wali_option" value="wali"
                               <?php echo e(old('jenis_pendamping', ($biodata->nama_ayah ?? null) ? 'ortu' : 'wali') == 'wali' ? 'checked' : ''); ?>
                ...
                <div id="ortu_section" class="mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control ortu-field" name="nama_ayah" id="nama_ayah" value="<?php echo e(old('nama_ayah', $biodata->nama_ayah ?? '')); ?>" placeholder="Masukkan nama ayah" <?php echo e($isSubmitted ? 'readonly' : ''); ?>>
                            <small class="text-muted">Hanya huruf dan spasi</small>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control ortu-field" name="pekerjaan_ayah" id="pekerjaan_ayah" value="<?php echo e(old('pekerjaan_ayah', $biodata->pekerjaan_ayah ?? '')); ?>" placeholder="Masukkan pekerjaan ayah" <?php echo e($isSubmitted ? 'readonly' : ''); ?>>
                            <small class="text-muted">Hanya huruf dan spasi</small>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control ortu-field" name="nama_ibu" id="nama_ibu" value="<?php echo e(old('nama_ibu', $biodata->nama_ibu ?? '')); ?>" placeholder="Masukkan nama ibu" <?php echo e($isSubmitted ? 'readonly' : ''); ?>>
                            <small class="text-muted">Hanya huruf dan spasi</small>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control ortu-field" name="pekerjaan_ibu" id="pekerjaan_ibu" value="<?php echo e(old('pekerjaan_ibu', $biodata->pekerjaan_ibu ?? '')); ?>" placeholder="Masukkan pekerjaan ibu" <?php echo e($isSubmitted ? 'readonly' : ''); ?>>
                            <small class="text-muted">Hanya huruf dan spasi</small>
                ...
                <div id="wali_section" class="mb-4" style="display: none;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control wali-field" name="nama_wali" id="nama_wali" value="<?php echo e(old('nama_wali', $biodata->nama_wali ?? '')); ?>" placeholder="Masukkan nama wali" <?php echo e($isSubmitted ? 'readonly' : ''); ?>>
                            <small class="text-muted">Hanya huruf dan spasi</small>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="asal_sekolah" id="asal_sekolah" value="<?php echo e(old('asal_sekolah', $biodata->asal_sekolah ?? $siswa->asal_sekolah ?? '')); ?>" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?>>
                        <small class="text-muted">Hanya huruf dan spasi</small>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="tahun_lulus" id="tahun_lulus" value="<?php echo e(old('tahun_lulus', $biodata->tahun_lulus ?? '')); ?>" placeholder="Contoh: 2025" pattern="[0-9]{4}" inputmode="numeric" maxlength="4" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?>>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppdb_denico_09\resources\views/user/biodata.blade.php ENDPATH**/ ?>