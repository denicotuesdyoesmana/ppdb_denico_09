                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6; transition: all 0.3s;" onmouseover="this.style.background='#f9fafb'" onmouseout="this.style.background=''">
                            <td style="padding: 15px; color: #1f2937;"><?php echo e($loop->iteration + ($siswa->currentPage() - 1) * $siswa->perPage()); ?></td>
                            <td style="padding: 15px;">
                                <div style="color: #1f2937; font-weight: 600;"><?php echo e($item->nama_lengkap); ?></div>
                            </td>
                            ...
                            <td style="padding: 15px;">
                                <div style="display: flex; flex-direction: row; gap: 6px; align-items: center;">
                                    <div style="font-size: 12px; color: #6b7280;">
                                        ...
                                        <span style="color: #f59e0b; font-weight: 600;">⏳ <?php echo e($menunggu); ?></span>
                                    </div>
                                    <div style="width: 100px; height: 6px; background: #e5e7eb; border-radius: 3px; overflow: hidden;">
                                        <div style="width: <?php echo e($persentase); ?>%; height: 100%; background: linear-gradient(90deg, #10b981, #34d399); transition: width 0.3s;"></div>
                                    </div>
                                </div>
                            </td>
                            <td style="padding: 15px;">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppdb_denico_09\resources\views/admin/verifikasi/index.blade.php ENDPATH**/ ?>