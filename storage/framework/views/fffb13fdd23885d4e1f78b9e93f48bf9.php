            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-6 mb-3">
                        ...
                        <div><?php echo e(optional($profileData)->nama_lengkap ?? $user->name ?? '-'); ?></div>
                    </div>
                    <div class="col-6 mb-3">
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <div><?php echo e(optional($profileData)->nisn ?? '-'); ?></div>
                    </div>
                    <div class="col-6 mb-3">
                        <small class="text-muted">NIK</small>
                        <div><?php echo e(optional($profileData)->nik ?? '-'); ?></div>
                    </div>
                    <div class="col-6 mb-3">
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <div><?php echo e(optional($profileData)->jenis_kelamin ?? '-'); ?></div>
                    </div>
                    <div class="col-6 mb-3">
                        <small class="text-muted">Asal Sekolah</small>
                        <div><?php echo e(optional($profileData)->asal_sekolah ?? '-'); ?></div>
                    </div>
                    <div class="col-6 mb-3">
                        <small class="text-muted">No. Telepon</small>
                        <div><?php echo e(optional($profileData)->no_hp ?? optional($profileData)->no_telepon ?? '-'); ?></div>
                    </div>
                    <div class="col-12 mb-3">
                        <small class="text-muted">Alamat</small>
                        <div><?php echo e(optional($profileData)->alamat ?? '-'); ?></div>
                    </div>
                    <?php if($biodata && $biodata->agama): ?>
                    <div class="col-6 mb-3">
                        <small class="text-muted">Agama</small>
                        <div><?php echo e($biodata->agama ?? '-'); ?></div>
                    </div>
                    <?php endif; ?>
                    <?php if($biodata && $biodata->nama_ayah): ?>
                    <div class="col-6 mb-3">
                        <small class="text-muted">Nama Ayah</small>
                        <div><?php echo e($biodata->nama_ayah ?? '-'); ?></div>
                    </div>
                    <?php endif; ?>
                    <?php if($biodata && $biodata->nama_ibu): ?>
                    <div class="col-6 mb-3">
                        <small class="text-muted">Nama Ibu</small>
                        <div><?php echo e($biodata->nama_ibu ?? '-'); ?></div>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppdb_denico_09\resources\views/myprofile.blade.php ENDPATH**/ ?>