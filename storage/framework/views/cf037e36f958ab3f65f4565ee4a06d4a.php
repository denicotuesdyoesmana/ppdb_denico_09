<?php $__env->startSection('content'); ?>
    <style>
        .hero-modern {
            padding: 100px 0;
            color: #fff;
            background: linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('<?php echo e(asset("assets/images/my/sekolah_depan.jpg")); ?>') !important;
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 d-none">
                    <img src="<?php echo e(asset('assets/images/my/sekolah_depan.jpg')); ?>" alt="Hero" class="img-fluid" style="max-width:420px; filter:drop-shadow(0 20px 40px rgba(0,0,0,0.15)); animation: float 3s ease-in-out infinite;">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="card card-modern p-4" style="border-left: 4px solid #10b981;">
                        <div class="d-flex mb-3">
                            <img src="<?php echo e(asset('assets/images/user/avatar-1.jpg')); ?>" alt="Rizky" class="rounded-circle me-3" style="width:56px; height:56px; object-fit:cover;">
                            <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-modern p-4" style="border-left: 4px solid #10b981;">
                        <div class="d-flex mb-3">
                            <img src="<?php echo e(asset('assets/images/user/avatar-2.jpg')); ?>" alt="Anisa" class="rounded-circle me-3" style="width:56px; height:56px; object-fit:cover;">
                            <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-modern p-4" style="border-left: 4px solid #10b981;">
                        <div class="d-flex mb-3">
                            <img src="<?php echo e(asset('assets/images/user/avatar-1.jpg')); ?>" alt="Budi" class="rounded-circle me-3" style="width:56px; height:56px; object-fit:cover;">
                            <div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppdb_denico_09\resources\views/welcome.blade.php ENDPATH**/ ?>