...
<head>
    ...
    <style>
        * {
        ...
        .sidebar {
            width: 260px;
            background: linear-gradient(180deg, #2d3748 0%, #374151 100%);
            color: white;
            height: 100vh;
            position: fixed;
            left: 0;
        ...
        .page-title {
            ...
            color: var(--dark);
            margin-bottom: 8px;
            background: linear-gradient(135deg, #1f2937 0%, #5eead4 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
        ...
        .card-header {
            background: linear-gradient(135deg, rgba(94, 234, 212, 0.05) 0%, rgba(240, 171, 252, 0.05) 100%);
...
<?php /**PATH C:\ppdb_denico_09\resources\views/layouts/master.blade.php ENDPATH**/ ?>