    ...
    <div class="col-12 col-lg-4">
        <div class="card card-modern">
            <div class="card-body text-center">
                ...
                @else
                    <div class="user-avatar user-avatar-lg mb-3" style="width:110px;height:110px;font-size:32px;">{{ strtoupper(substr($user->name ?? 'U', 0, 1)) }}</div>
                @endif
                ...
                <div class="d-grid gap-2 mt-3">
                    <a href="{{ route('profil.edit') }}" class="btn btn-modern btn-modern-primary"><i class="fas fa-edit me-1"></i>Edit Profil</a>
                    <a href="{{ route('password.change') }}" class="btn btn-modern btn-modern-outline"><i class="fas fa-key me-1"></i>Ubah Password</a>
                </div>
            </div>
        </div>
                    ...
                    @if($siswa)
                        @forelse($siswa->dokumen()->latest()->limit(5)->get() as $doc)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('user.dokumen.download', $doc->id) }}" class="btn btn-sm btn-modern btn-modern-outline">Download</a>
                                </div>
                            </li>
                        @empty
