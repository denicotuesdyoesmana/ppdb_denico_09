                ...
                <tbody>
                    @forelse ($siswa as $item)
                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6; transition: all 0.3s;" onmouseover="this.style.background='#f9fafb'" onmouseout="this.style.background=''">
                            ...
                            <td style="padding: 15px;">
                                <a href="{{ route('admin.verifikasi.siswa', $item->id) }}" style="padding: 8px 16px; background: linear-gradient(135deg, #14b8a6 0%, #5eead4 100%); color: white; text-decoration: none; border-radius: 6px; font-size: 12px; font-weight: 600; display: inline-flex; align-items: center; gap: 6px; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 12px rgba(20, 184, 166, 0.3)'" onmouseout="this.style.transform=''; this.style.boxShadow=''">
