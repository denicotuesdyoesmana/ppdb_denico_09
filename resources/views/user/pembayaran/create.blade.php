        ...
        <div class="card-body">
            ...
            @if($pendaftaran && $pendaftaran->harga_gelombang > 0)
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <ul class="mb-0 mt-2">
                        <li><strong>Gelombang:</strong> {{ $pendaftaran->gelombang }}</li>
                        <li><strong>Jenis Pembayaran:</strong> {{ $pendaftaran->jenis_pembayaran ?? 'Uang Pendaftaran' }}</li>
                        <li><strong>Jumlah Pembayaran:</strong> <span class="text-success fw-bold">Rp {{ number_format($pendaftaran->harga_gelombang, 0, ',', '.') }}</span></li>
                        @if($pendaftaran->tujuan_rekening)
                            <li><strong>Tujuan Rekening (Read-Only):</strong>
                                <div style="margin-top: 8px; padding: 10px; background-color: #e7f3ff; border-left: 3px solid #0ea5e9; border-radius: 4px;">
                    ...
                    <div id="ewallet_section" style="display: none;" class="mb-4 p-3 border border-success rounded" style="background-color: #f0fff4;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="nomor_ewallet" id="nomor_ewallet"
                                       class="form-control @error('nomor_ewallet') is-invalid @enderror"
                                       placeholder="Contoh: 08xxxxxxxxxx"
                                       value="{{ old('nomor_ewallet') }}" min="0" required>
                                <small class="text-muted d-block mt-1">Nomor HP atau ID yang terdaftar di e-wallet (hanya angka)</small>
                                @error('nomor_ewallet')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
